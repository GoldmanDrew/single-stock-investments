...
|---|---------------|------------|--------------|--------|----------|
| 1 | Latest revenue (filing) | — | **$455.71B** vs prior $249.37B (+82.8% YoY) | spot-check dive | — |
| — | Stockholders' equity (filing) | — | **2183.0** | spot-check dive | — |
| — | Net income (filing) | — | **38228.0** | spot-check dive | — |
| — | EPS basic (filing) | — | **0.64** | spot-check dive | — |
...
**Lint notes:**
- AAOI/research: dive header cites adversarial but file missing
