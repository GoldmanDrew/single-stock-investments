...
- `ADBE/research/valuation_route.json`
- `ADBE/research/valuation_contract.json`
- `ADBE/research/valuation.json`
- `ADBE/research/thesis.md`
- `ADBE/research/cross_check_third_party_2026-07-21.md`
- `ADBE/research/evidence_reconciliation_2026-07-21.md`
- `ADBE/research/evidence/filing_facts_2026-07-21.json`
- `ADBE/research/evidence/management_facts_2026-07-21.json`
...
8. Return only one JSON object matching the committee schema vote definition, including `"evidence_hash": "2a9cc2a60fa3eacd3d50be6f31d6da04a29b176ed658868867dfc412b0de127c"`. A vote whose evidence_hash does not match the packet it answers is rejected.
