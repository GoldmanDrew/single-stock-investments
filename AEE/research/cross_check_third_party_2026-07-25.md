...
Marvin Lawrence synthesis **6.76%** per year (infrastructure; stance **watch**) from primary filings and `valuation.json`. Universal contract at **decision_grade** values additive components at **$43.38/sh** base (**-12.9%** annualized at **$113.78**). No third-party sources indexed; filings-only stance. **[HUMAN REVIEW]** for approved-source numeric blend.

**Synthesis (best estimate):** Marvin **6.76%** Lawrence base · contract **$43.38/sh** · stance **watch**; external sources adjust conviction on catalyst timing, not primary IRR without human OK.
...
|-------|------------------|----------|--------|
| Base return anchor | **6.76%** per year (Lawrence synthesis) | Qualitative support only | `AEE/research/deep_dive_2026-07-25.md` |
...
|-------|--------------|----------|-------------|
| Primary IRR | **6.76%** (Lawrence synthesis) | No single approved IRR unless promoted | Marvin **70%** numeric; external **30%** catalyst timing |
...
|------|-------------------|------------------|-------------|
| Marvin floor (Lawrence) | $5.10/sh normalized earnings power | **6.76%** | **watch** |
| Contract (decision_grade) | **$43.38/sh** additive | **-12.9%** at spot | **watch** (valuation discipline) |
| External (combined) | Narrative / catalyst | No change to base % | **watch** (conviction) |
| **Blended best estimate** | **Filing anchor** | **6.76%** Lawrence · **$43.38/sh** contract | **watch** |
...
- [ ] Reconcile Lawrence 6.76% stance gate with contract -12.9% at price for capital decisions

## [PROPOSED MEMORY]

- [PROPOSED COMPANY] AEE: universal contract at decision_grade 2026-07-25 — four additive components; Lawrence synthesis **6.76%** at **$113.78**; contract base **$43.38/sh**.
