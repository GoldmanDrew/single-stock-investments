...
**Dive reviewed:** `SPGI/research/deep_dive_2026-05-28.md`  
**Valuation reviewed:** `SPGI/research/valuation.json`  
**Filings used:** `SPGI/research/evidence/filing_facts_2026-05-28.json`
...
**Lint notes:**
- SPGI/research: missing adversarial_*.md — run Milly standard pass
- SPGI\research\deep_dive_2026-05-28.md: header missing **Adversarial review:** link
