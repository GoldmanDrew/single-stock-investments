...
Use before marking any deep-dive or thesis update ready for human review.
...
## Valuation context (optional at deep-dive stage)
- [ ] Document current multiples vs own history
- [ ] Identify what must be true for investment to work
