...
| `sec_filer:telluray_holdings_llc` | 48 |
| `sec_filer:franklin_resources_inc` | 41 |
| `sec_filer:berkshire_hathaway_inc` | 36 |
| `sec_filer:dennis_j_wilson_anamered_investments_inc_lipo_investments_usa_inc_wilson_5_found` | 33 |
| `sec_filer:mantle_ridge_lp` | 32 |
| `sec_filer:charles_w_ergen` | 30 |
| `sec_filer:riot_platforms_inc` | 28 |
| `sec_filer:warren_e_buffett` | 27 |
| `sec_filer:mjh_partners_ii_llc` | 25 |
| `sec_filer:s_general_electric_company` | 19 |
| `sec_filer:8194` | 19 |
| `sec_filer:strategic_organizing_center` | 18 |
| `sec_filer:s_roman_dbdr_tech_sponsor_llc_2` | 17 |
| `sec_filer:i_r_s_identification_nos_of_above_persons_entities_only` | 17 |
| `sec_filer:s_advance_publications_inc` | 15 |
| `sec_filer:honeywell_international_inc_2` | 14 |
| `sec_filer:delta_air_lines_inc` | 13 |
...
| `sec_filer:melinda_gates_foundation_trust` | 11 |
| `sec_filer:s_s_or` | 11 |
| `sec_filer:blackwells_capital_llc_blackwells_onshore_i_llc_jason_aintabi_craig_hatkoff_leah` | 11 |
| `sec_filer:new_omaha_holdings_l_p` | 11 |
