...
`python _system/scripts/marvin_valuation.py --ticker TEQ.ST --write`
...
- Confirm live price
- Hold override for quality serial-acquirer sleeve?
- Entry ~130 SEK for ~15% base IRR
