...
QUEUE_TYPES: tuple[QueueType, ...] = (
    ...
    QueueType(
        ...
        pattern=rf"^memory_digest_{DATE_RE}\.md$",
        disposition=HUMAN_VERDICT,
        requires="Promote approved bullets into MEMORY.md, log rejections in corrections.md.",
        source="build_memory_digest.py",
        rationale="Non-overlapping weekly windows: an unreviewed week is NOT restated later.",
    ),
    QueueType(
        id="cvr_discovery",
        label="CVR discovery",
