...
def core_engine_proof(cfg: dict) -> dict:
    ...
    return {
        ...
        "assumptions": [
            _judgment("growth_y1_5", "Growth years 1–5", growth1, "ratio", cfg.get("growth_rationale", "Filing-aligned growth bands."), -0.05, 0.25),
            _judgment("growth_y6_10", "Growth years 6–7", growth2, "ratio", "Fade toward mid-cycle.", -0.05, 0.15),
            _judgment("discount_rate", "Required return on owner cash", discount, "ratio", cfg.get("discount_rationale", "Business risk bounds."), 0.06, 0.16),
            _judgment("exit_multiple", "Selling multiple in year 7", exit_mult, "multiple", "Aligned to Lawrence exit multiples.", 8, 32),
        ],
        "calculations": calcs,
